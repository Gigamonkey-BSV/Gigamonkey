...
namespace Gigamonkey::Boost {
    ...
    TEST(BoostTest, TestBoost) {
        ...
        bool check_scripts = dot_cross([](bytes_view in, bytes_view out) {
            return Bitcoin::interpreter::evaluate(in, out).valid();
    ...
    TEST(BoostTest, DoExtraPoW1) {
        ...
        string raw_tx_hex{ "010000000174d9f6dc235207fbbcdff7bdc412dcb375eb634da698ed164cc1e9aa1b88729a040000006b4830450221008596410738406e0e85892"
    ...
    TEST(BoostTest, DoExtraPoW2) {
        ...
        string raw_tx_hex{ "01000000018ff2fe10e8629051853507b4189bf3981569a0d358e0506033a11618f2e3b10c010000006b483045022100f82288631d8c8b6b6fba"
        ...
        std::cout << "done mining; nonce = " << encoding::hex::write(pr.Solution.Share.Nonce) << "; extra_nonce_2 = " 
            << encoding::hex::write(pr.Solution.Share.ExtraNonce2) << std::endl;
