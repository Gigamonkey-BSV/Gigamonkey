...
namespace Gigamonkey::Boost {
    ...
    public:
        ...
        work::proof solve () const {
            return work::cpu_solve (work_puzzle (Script, Bitcoin::Hash160 (Key.to_public ())), initial_solution ());
        }
    };
    ...
    TEST (BoostTest, DoExtraPoW1) {
        ...
        Bitcoin::transaction tx = Bitcoin::transaction {*data::encoding::hex::read (encoding::hex::string {
            ...
            "92a0e7a4d960e739025ab1859a3df6c77b4cf8c59ac0220733024f199162bc7b9c"
            "cd648aae56f0a0e307558a9827a26d35b1016de1865c54121025a77fe27d1db166"
            "b660205ff08b97f7dd87c7c68edaa2931895c2c8577f1a351ffffffff027d20000"
            "000000000e108626f6f7374706f777504000000002035b8fcb6882f93bddb928c9"
            "872198bcdf057ab93ed615ad938f24a63abde588104ffff001d140000000000000"
            "000000000000000000000000000040000000020000000000000000000000000000"
            "00000000000000000000000000000000000007e7c557a766b7e52796b557a82548"
            "87e557a8258887e7c7eaa7c6b7e7e7c8254887e6c7e7c8254887eaa01007e816c8"
            "25488537f7681530121a5696b768100a0691d00000000000000000000000000000"
    ...
    TEST (BoostTest, DoExtraPoW2) {
        ...
        Bitcoin::transaction tx = Bitcoin::transaction {*data::encoding::hex::read (encoding::hex::string {
            ...
            "9094a6d56af6ab572347b7365dcf7e6d68905cb8fd000220390cde292cc50a92bd"
            "60e680bfcbddf17443d904c7372880b6ec312a06952fb3412102be82a62c8c3d8"
            "e949c9b54a60b4cadf0efacec08164b3eca3b6e793f52bf8d8affffffff0220090"
            "000000000001976a914cdb2b66b5fa33fa3f55fb9296f31d445892d990988ace2"
            "18000000000000e108626f6f7374706f7775047800000020325593000000000000"
            "000000000000000000000000000000000000000000000004ffff001d142312000"
            "000000000000000000000000000000000048866000020940000000000000000000"
            "00000000000000000000000000000000000000000007e7c557a766b7e52796b55"
            "7a8254887e557a8258887e7c7eaa7c6b7e7e7c8254887e6c7e7c8254887eaa010"
    ...
    TEST (BoostTest, TestAgainstBoostPoWJS) {
        ...
        digest160 miner_pubkey_hash = Bitcoin::Hash160 (miner_pubkey);
        ...
        output_script locking_script_bounty_v1 = output_script::bounty (
            ...
            content, compact, bytes (given_tag),
        ...
        input_script unlocking_script_bounty_v1 = input_script::bounty (
            ...
            miner_pubkey, expected_nonce_number_v1,
            timestamp, expected_extra_nonce_2,
            extra_nonce_1, miner_pubkey_hash);
        
        input_script unlocking_script_bounty_v2 = input_script::bounty (
            Bitcoin::signature (bytes (given_signature)),
            miner_pubkey, expected_nonce_number_v2,
            timestamp, expected_extra_nonce_2,
            extra_nonce_1, general_purpose_bits_number,
            miner_pubkey_hash);
    ...
    TEST (BoostTest, TestAgainstBoostPoWJSRedeem) {
        ...
        digest160 miner_pubkey_hash = Hash160 (miner_pubkey);
