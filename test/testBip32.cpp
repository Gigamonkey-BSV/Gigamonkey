...
TEST(Bip32,PublicRead) {
    ...
    ASSERT_THAT(read.Pubkey, testing::ElementsAre(0x03,0x39,0xA3,0x60,0x13,0x30,0x15,0x97,0xDA,0xEF,0x41,0xFB,0xE5,0x93,0xA0,0x2C,0xC5,0x13,0xD0,0xB5,0x55,0x27,0xEC,0x2D,0xF1,0x05,0x0E,0x2E,0x8F,0xF4,0x9C,0x85,0xC2)) << "Invalid Secret Key";
}
