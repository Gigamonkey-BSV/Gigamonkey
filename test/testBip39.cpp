...
class Bip39Tests : public ::testing::TestWithParam<std::tuple<Gigamonkey::HD::BIP_39::language,std::string,std::string,std::string,std::string,std::string>>
{
...
TEST_P(Bip39Tests,WordsToSeed) {
    ...
    Gigamonkey::HD::seed seed=Gigamonkey::HD::BIP_39::read(words,std::get<3>(GetParam()),std::get<0>(GetParam()));
...
INSTANTIATE_TEST_SUITE_P(Bip39,Bip39Tests,::testing::Values(
        /*std::make_tuple(
                Gigamonkey::HD::BIP_39::language::japanese,
