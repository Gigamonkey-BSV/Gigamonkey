...
class Bip39Tests : public ::testing::TestWithParam<std::tuple<Gigamonkey::Bitcoin::hd::bip39::languages,std::string,std::string,std::string,std::string,std::string>>
{
...
INSTANTIATE_TEST_SUITE_P(Bip39,Bip39Tests,::testing::Values(
        /*std::make_tuple(
                Gigamonkey::Bitcoin::hd::bip39::languages::japanese,
    ...
    std::make_tuple(
            Gigamonkey::Bitcoin::hd::bip39::languages::english,
