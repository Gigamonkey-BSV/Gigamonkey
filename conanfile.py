...
class GigamonkeyConan (ConanFile):
    ...
    requires = "boost/1.80.0", "openssl/1.1.1t", "cryptopp/8.5.0", "nlohmann_json/3.11.2", "gmp/6.2.1", "secp256k1/0.3@proofofwork/stable", "data/v0.0.25@proofofwork/stable", "gtest/1.12.1"
