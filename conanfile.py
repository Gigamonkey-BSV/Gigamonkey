...
class GigamonkeyConan(ConanFile):
    ...
    generators = "cmake"
    exports_sources = "*"
    requires = "boost/1.76.0", "openssl/1.1.1k", "cryptopp/8.5.0", "nlohmann_json/3.10.0", "gmp/6.2.1", "SECP256K1/0.2@proofofwork/stable", "data/v0.0.13@proofofwork/stable", "gtest/1.12.1"
