...
namespace Gigamonkey {
    ...
    template <> bool numbers::less<endian::little>(const digits<endian::little> a, const digits<endian::little> b) { 
        return bsv::bint::deserialize(bsv::span<byte>(const_cast<byte*>(a.Data.data()), a.Data.size())) < 
            bsv::bint::deserialize(bsv::span<byte>(const_cast<byte*>(b.Data.data()), b.Data.size()));
    }
    ...
    template <> std::vector<byte> numbers::plus<endian::little>(const digits<endian::little> a, const digits<endian::little> b) { 
        return (bsv::bint::deserialize(bsv::span<byte>(const_cast<byte*>(a.Data.data()), a.Data.size())) +
            bsv::bint::deserialize(bsv::span<byte>(const_cast<byte*>(b.Data.data()), b.Data.size()))).serialize();
    }
