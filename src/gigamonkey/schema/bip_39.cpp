...
namespace Gigamonkey::HD::BIP_39 {
    ...
    const cross<UTF8> &japanese_words () {
        static cross<UTF8> Words {
            ...
            UTF8 {"にんそう"},
            UTF8 {"にんたい"}, UTF8 {"にんち"}, UTF8 {"にんてい"},
            UTF8 {"にんにく"}, UTF8 {"にんぷ"},
            UTF8 {"にんまり"}, UTF8 {"にんむ"}, UTF8 {"にんめい"},
            UTF8 {"にんよう"}, UTF8 {"ぬいくぎ"}, UTF8 {"ぬかす"},
            UTF8 {"ぬぐいとる"}, UTF8 {"ぬぐう"}, UTF8 {"ぬくもり"}, UTF8 {"ぬすむ"},
            UTF8 {"ぬまえび"}, UTF8 {"ぬめり"}, UTF8 {"ぬらす"},
            UTF8 {"ぬんちゃく"}, UTF8 {"ねあげ"}, UTF8 {"ねいき"},
            UTF8 {"ねいる"}, UTF8 {"ねいろ"}, UTF8 {"ねぐせ"},
            UTF8 {"ねくたい"}, UTF8 {"ねくら"},
            UTF8 {"ねこぜ"}, UTF8 {"ねこむ"}, UTF8 {"ねさげ"},
            UTF8 {"ねすごす"}, UTF8 {"ねそべる"}, UTF8 {"ねだん"},
            UTF8 {"ねつい"}, UTF8 {"ねっしん"}, UTF8 {"ねつぞう"},
            UTF8 {"ねったいぎょ"},
            UTF8 {"ねぶそく"}, UTF8 {"ねふだ"}, UTF8 {"ねぼう"},
            UTF8 {"ねほりはほり"}, UTF8 {"ねまき"}, UTF8 {"ねまわし"},
            UTF8 {"ねみみ"}, UTF8 {"ねむい"}, UTF8 {"ねむたい"},
            UTF8 {"ねもと"}, UTF8 {"ねらう"},
            UTF8 {"ねわざ"}, UTF8 {"ねんいり"}, UTF8 {"ねんおし"},
            UTF8 {"ねんかん"}, UTF8 {"ねんきん"}, UTF8 {"ねんぐ"},
            UTF8 {"ねんざ"}, UTF8 {"ねんし"}, UTF8 {"ねんちゃく"},
            UTF8 {"ねんど"}, UTF8 {"ねんぴ"},
            UTF8 {"ねんぶつ"}, UTF8 {"ねんまつ"}, UTF8 {"ねんりょう"},
            UTF8 {"ねんれい"}, UTF8 {"のいず"}, UTF8 {"のおづま"},
            UTF8 {"のがす"}, UTF8 {"のきなみ"}, UTF8 {"のこぎり"},
            UTF8 {"のこす"},
            UTF8 {"のこる"}, UTF8 {"のせる"}, UTF8 {"のぞく"},
            UTF8 {"のぞむ"}, UTF8 {"のたまう"}, UTF8 {"のちほど"},
            UTF8 {"のっく"}, UTF8 {"のばす"}, UTF8 {"のはら"},
            UTF8 {"のべる"}, UTF8 {"のぼる"}, UTF8 {"のみもの"},
            UTF8 {"のやま"},
            UTF8 {"のらいぬ"}, UTF8 {"のらねこ"}, UTF8 {"のりもの"},
            UTF8 {"のりゆき"}, UTF8 {"のれん"}, UTF8 {"のんき"},
            UTF8 {"ばあい"}, UTF8 {"はあく"}, UTF8 {"ばあさん"},
            UTF8 {"ばいか"}, UTF8 {"ばいく"}, UTF8 {"はいけん"},
            UTF8 {"はいご"}, UTF8 {"はいしん"}, UTF8 {"はいすい"},
            UTF8 {"はいせん"}, UTF8 {"はいそう"}, UTF8 {"はいち"},
            UTF8 {"ばいばい"}, UTF8 {"はいれつ"}, UTF8 {"はえる"},
            UTF8 {"はおる"}, UTF8 {"はかい"}, UTF8 {"ばかり"},
            UTF8 {"はかる"},
            UTF8 {"はくしゅ"}, UTF8 {"はけん"}, UTF8 {"はこぶ"},
            UTF8 {"はさみ"}, UTF8 {"はさん"}, UTF8 {"はしご"},
            UTF8 {"ばしょ"}, UTF8 {"はしる"}, UTF8 {"はせる"},
            UTF8 {"ぱそこん"}, UTF8 {"はそん"}, UTF8 {"はたん"},
            UTF8 {"はちみつ"},
            UTF8 {"はつおん"}, UTF8 {"はっかく"}, UTF8 {"はづき"},
            UTF8 {"はっきり"}, UTF8 {"はっくつ"}, UTF8 {"はっけん"},
            UTF8 {"はっこう"}, UTF8 {"はっさん"}, UTF8 {"はっしん"},
            UTF8 {"はったつ"}, UTF8 {"はっちゅう"}, UTF8 {"はってん"},
            UTF8 {"はっぴょう"}, UTF8 {"はっぽう"}, UTF8 {"はなす"},
            UTF8 {"はなび"}, UTF8 {"はにかむ"}, UTF8 {"はぶらし"},
            UTF8 {"はみがき"}, UTF8 {"はむかう"}, UTF8 {"はめつ"},
            UTF8 {"はやい"}, UTF8 {"はやし"}, UTF8 {"はらう"},
            UTF8 {"はろうぃん"}, UTF8 {"はわい"}, UTF8 {"はんい"},
            UTF8 {"はんえい"}, UTF8 {"はんおん"}, UTF8 {"はんかく"},
            UTF8 {"はんきょう"}, UTF8 {"ばんぐみ"}, UTF8 {"はんこ"},
            UTF8 {"はんしゃ"}, UTF8 {"はんすう"}, UTF8 {"はんだん"},
            UTF8 {"ぱんち"}, UTF8 {"ぱんつ"}, UTF8 {"はんてい"},
            UTF8 {"はんとし"}, UTF8 {"はんのう"}, UTF8 {"はんぱ"},
            UTF8 {"はんぶん"}, UTF8 {"はんぺん"}, UTF8 {"はんぼうき"},
            UTF8 {"はんめい"}, UTF8 {"はんらん"},
            UTF8 {"はんろん"},
            UTF8 {"ひいき"}, UTF8 {"ひうん"}, UTF8 {"ひえる"},
            UTF8 {"ひかく"}, UTF8 {"ひかり"}, UTF8 {"ひかる"},
            UTF8 {"ひかん"}, UTF8 {"ひくい"}, UTF8 {"ひけつ"},
            UTF8 {"ひこうき"}, UTF8 {"ひこく"}, UTF8 {"ひさい"},
            UTF8 {"ひさしぶり"},
            UTF8 {"ひさん"}, UTF8 {"びじゅつかん"}, UTF8 {"ひしょ"},
            UTF8 {"ひそか"}, UTF8 {"ひそむ"}, UTF8 {"ひたむき"},
            UTF8 {"ひだり"}, UTF8 {"ひたる"}, UTF8 {"ひつぎ"},
            UTF8 {"ひっこし"}, UTF8 {"ひっし"}, UTF8 {"ひつじゅひん"},
            UTF8 {"ひっす"}, UTF8 {"ひつぜん"}, UTF8 {"ぴったり"},
            UTF8 {"ぴっちり"}, UTF8 {"ひつよう"}, UTF8 {"ひてい"},
            UTF8 {"ひとごみ"}, UTF8 {"ひなまつり"}, UTF8 {"ひなん"},
            UTF8 {"ひねる"}, UTF8 {"ひはん"}, UTF8 {"ひびく"},
            UTF8 {"ひひょう"}, UTF8 {"ひほう"}, UTF8 {"ひまわり"},
            UTF8 {"ひまん"}, UTF8 {"ひみつ"}, UTF8 {"ひめい"},
            UTF8 {"ひめじし"}, UTF8 {"ひやけ"}, UTF8 {"ひやす"},
            UTF8 {"ひよう"}, UTF8 {"びょうき"}, UTF8 {"ひらがな"},
            UTF8 {"ひらく"},
            UTF8 {"ひりつ"}, UTF8 {"ひりょう"}, UTF8 {"ひるま"},
            UTF8 {"ひるやすみ"}, UTF8 {"ひれい"}, UTF8 {"ひろい"},
            UTF8 {"ひろう"}, UTF8 {"ひろき"}, UTF8 {"ひろゆき"},
            UTF8 {"ひんかく"}, UTF8 {"ひんけつ"}, UTF8 {"ひんこん"},
            UTF8 {"ひんしゅ"}, UTF8 {"ひんそう"}, UTF8 {"ぴんち"},
            UTF8 {"ひんぱん"}, UTF8 {"びんぼう"}, UTF8 {"ふあん"},
            UTF8 {"ふいうち"}, UTF8 {"ふうけい"}, UTF8 {"ふうせん"},
            UTF8 {"ぷうたろう"}, UTF8 {"ふうとう"}, UTF8 {"ふうふ"},
            UTF8 {"ふえる"}, UTF8 {"ふおん"}, UTF8 {"ふかい"},
            UTF8 {"ふきん"}, UTF8 {"ふくざつ"}, UTF8 {"ふくぶくろ"},
            UTF8 {"ふこう"}, UTF8 {"ふさい"}, UTF8 {"ふしぎ"},
            UTF8 {"ふじみ"}, UTF8 {"ふすま"}, UTF8 {"ふせい"},
            UTF8 {"ふせぐ"},
            UTF8 {"ふそく"}, UTF8 {"ぶたにく"}, UTF8 {"ふたん"},
            UTF8 {"ふちょう"}, UTF8 {"ふつう"}, UTF8 {"ふつか"},
            UTF8 {"ふっかつ"}, UTF8 {"ふっき"}, UTF8 {"ふっこく"},
            UTF8 {"ぶどう"}, UTF8 {"ふとる"}, UTF8 {"ふとん"},
            UTF8 {"ふのう"},
            UTF8 {"ふはい"}, UTF8 {"ふひょう"}, UTF8 {"ふへん"},
            UTF8 {"ふまん"}, UTF8 {"ふみん"}, UTF8 {"ふめつ"},
            UTF8 {"ふめん"}, UTF8 {"ふよう"}, UTF8 {"ふりこ"},
            UTF8 {"ふりる"}, UTF8 {"ふるい"}, UTF8 {"ふんいき"},
            UTF8 {"ぶんがく"},
            UTF8 {"ぶんぐ"}, UTF8 {"ふんしつ"}, UTF8 {"ぶんせき"},
            UTF8 {"ふんそう"}, UTF8 {"ぶんぽう"},
            UTF8 {"へいあん"},
            UTF8 {"へいおん"}, UTF8 {"へいがい"}, UTF8 {"へいき"},
            UTF8 {"へいげん"}, UTF8 {"へいこう"}, UTF8 {"へいさ"},
            UTF8 {"へいしゃ"}, UTF8 {"へいせつ"}, UTF8 {"へいそ"},
            UTF8 {"へいたく"}, UTF8 {"へいてん"}, UTF8 {"へいねつ"},
            UTF8 {"へいわ"}, UTF8 {"へきが"}, UTF8 {"へこむ"},
            UTF8 {"べにいろ"}, UTF8 {"べにしょうが"}, UTF8 {"へらす"},
            UTF8 {"へんかん"}, UTF8 {"べんきょう"}, UTF8 {"べんごし"},
            UTF8 {"へんさい"}, UTF8 {"へんたい"},
            UTF8 {"べんり"},
            UTF8 {"ほあん"}, UTF8 {"ほいく"}, UTF8 {"ぼうぎょ"},
            UTF8 {"ほうこく"}, UTF8 {"ほうそう"}, UTF8 {"ほうほう"},
            UTF8 {"ほうもん"}, UTF8 {"ほうりつ"}, UTF8 {"ほえる"},
            UTF8 {"ほおん"}, UTF8 {"ほかん"}, UTF8 {"ほきょう"},
            UTF8 {"ぼきん"}, UTF8 {"ほくろ"}, UTF8 {"ほけつ"},
            UTF8 {"ほけん"}, UTF8 {"ほこう"}, UTF8 {"ほこる"},
            UTF8 {"ほしい"},
            UTF8 {"ほしつ"}, UTF8 {"ほしゅ"}, UTF8 {"ほしょう"},
            UTF8 {"ほせい"}, UTF8 {"ほそい"}, UTF8 {"ほそく"},
            ...
            UTF8 {"まこと"},
            UTF8 {"まさつ"}, UTF8 {"まじめ"}, UTF8 {"ますく"},
            UTF8 {"まぜる"}, UTF8 {"まつり"}, UTF8 {"まとめ"},
            UTF8 {"まなぶ"}, UTF8 {"まぬけ"}, UTF8 {"まねく"},
            UTF8 {"まほう"}, UTF8 {"まもる"}, UTF8 {"まゆげ"},
            UTF8 {"まよう"}, UTF8 {"まろやか"},
            UTF8 {"まわす"}, UTF8 {"まわり"}, UTF8 {"まわる"},
            UTF8 {"まんが"}, UTF8 {"まんきつ"}, UTF8 {"まんぞく"},
            UTF8 {"まんなか"}, UTF8 {"みいら"}, UTF8 {"みうち"},
            UTF8 {"みえる"}, UTF8 {"みがく"}, UTF8 {"みかた"},
            UTF8 {"みかん"},
            UTF8 {"みけん"}, UTF8 {"みこん"}, UTF8 {"みじかい"},
            UTF8 {"みすい"}, UTF8 {"みすえる"}, UTF8 {"みせる"},
            UTF8 {"みっか"}, UTF8 {"みつかる"}, UTF8 {"みつける"},
            UTF8 {"みてい"}, UTF8 {"みとめる"}, UTF8 {"みなと"},
            UTF8 {"みなみかさい"}, UTF8 {"みねらる"}, UTF8 {"みのう"},
            UTF8 {"みのがす"}, UTF8 {"みほん"}, UTF8 {"みもと"},
            UTF8 {"みやげ"}, UTF8 {"みらい"}, UTF8 {"みりょく"},
            UTF8 {"みわく"}, UTF8 {"みんか"}, UTF8 {"みんぞく"},
            UTF8 {"むいか"}, UTF8 {"むえき"}, UTF8 {"むえん"},
            UTF8 {"むかい"}, UTF8 {"むかう"}, UTF8 {"むかえ"},
            UTF8 {"むかし"}, UTF8 {"むぎちゃ"}, UTF8 {"むける"},
            UTF8 {"むげん"}, UTF8 {"むさぼる"}, UTF8 {"むしあつい"},
            UTF8 {"むしば"},
            UTF8 {"むじゅん"}, UTF8 {"むしろ"}, UTF8 {"むすう"},
            UTF8 {"むすこ"}, UTF8 {"むすぶ"}, UTF8 {"むすめ"},
            UTF8 {"むせる"}, UTF8 {"むせん"}, UTF8 {"むちゅう"},
            UTF8 {"むなしい"}, UTF8 {"むのう"}, UTF8 {"むやみ"},
            UTF8 {"むよう"},
            ...
            UTF8 {"もうしあげる"}, UTF8 {"もうどうけん"},
            UTF8 {"もえる"}, UTF8 {"もくし"}, UTF8 {"もくてき"},
            UTF8 {"もくようび"},
            UTF8 {"もちろん"}, UTF8 {"もどる"}, UTF8 {"もらう"},
            UTF8 {"もんく"}, UTF8 {"もんだい"}, UTF8 {"やおや"},
            UTF8 {"やける"}, UTF8 {"やさい"}, UTF8 {"やさしい"},
            UTF8 {"やすい"}, UTF8 {"やすたろう"}, UTF8 {"やすみ"},
            UTF8 {"やせる"}, UTF8 {"やそう"}, UTF8 {"やたい"},
            UTF8 {"やちん"}, UTF8 {"やっと"}, UTF8 {"やっぱり"},
            UTF8 {"やぶる"},
            UTF8 {"やめる"}, UTF8 {"ややこしい"}, UTF8 {"やよい"},
            UTF8 {"やわらかい"}, UTF8 {"ゆうき"},
            UTF8 {"ゆうびんきょく"}, UTF8 {"ゆうべ"}, UTF8 {"ゆうめい"},
            UTF8 {"ゆけつ"}, UTF8 {"ゆしゅつ"}, UTF8 {"ゆせん"},
            UTF8 {"ゆそう"},
            UTF8 {"ゆたか"}, UTF8 {"ゆちゃく"}, UTF8 {"ゆでる"},
            UTF8 {"ゆにゅう"}, UTF8 {"ゆびわ"}, UTF8 {"ゆらい"},
            UTF8 {"ゆれる"}, UTF8 {"ようい"}, UTF8 {"ようか"},
            UTF8 {"ようきゅう"}, UTF8 {"ようじ"}, UTF8 {"ようす"},
            UTF8 {"ようちえん"},
            UTF8 {"よかぜ"}, UTF8 {"よかん"}, UTF8 {"よきん"},
            UTF8 {"よくせい"}, UTF8 {"よくぼう"}, UTF8 {"よけい"},
            UTF8 {"よごれる"}, UTF8 {"よさん"}, UTF8 {"よしゅう"},
            UTF8 {"よそう"}, UTF8 {"よそく"}, UTF8 {"よっか"},
            UTF8 {"よてい"},
            UTF8 {"よどがわく"}, UTF8 {"よねつ"}, UTF8 {"よやく"},
            UTF8 {"よゆう"}, UTF8 {"よろこぶ"}, UTF8 {"よろしい"},
            UTF8 {"らいう"}, UTF8 {"らくがき"}, UTF8 {"らくご"},
            UTF8 {"らくさつ"}, UTF8 {"らくだ"}, UTF8 {"らしんばん"},
            UTF8 {"らせん"}, UTF8 {"らぞく"}, UTF8 {"らたい"},
            UTF8 {"らっか"}, UTF8 {"られつ"}, UTF8 {"りえき"},
            UTF8 {"りかい"}, UTF8 {"りきさく"}, UTF8 {"りきせつ"},
            UTF8 {"りくぐん"}, UTF8 {"りくつ"}, UTF8 {"りけん"},
            UTF8 {"りこう"},
            UTF8 {"りせい"}, UTF8 {"りそう"}, UTF8 {"りそく"},
            UTF8 {"りてん"}, UTF8 {"りねん"}, UTF8 {"りゆう"},
            UTF8 {"りゅうがく"}, UTF8 {"りよう"}, UTF8 {"りょうり"},
            UTF8 {"りょかん"}, UTF8 {"りょくちゃ"}, UTF8 {"りょこう"},
            UTF8 {"りりく"}, UTF8 {"りれき"}, UTF8 {"りろん"},
            UTF8 {"りんご"}, UTF8 {"るいけい"}, UTF8 {"るいさい"},
