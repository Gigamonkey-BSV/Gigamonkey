...
namespace Gigamonkey::HD::BIP_39 {
    ...
    const cross<UTF8> &japanese_words () {
        static cross<UTF8> Words {
            ...
            UTF8 {"おんせん"}, UTF8 {"おんだん"}, UTF8 {"おんちゅう"}, UTF8 {"おんどけい"},  UTF8 {"かあつ"},
            UTF8 {"かいが"}, UTF8 {"がいき"}, UTF8 {"がいけん"}, UTF8 {"がいこう"}, UTF8 {"かいさつ"}, UTF8 {"かいしゃ"},
            UTF8 {"かいすいよく"}, UTF8 {"かいぜん"}, UTF8 {"かいぞうど"}, UTF8 {"かいつう"}, UTF8 {"かいてん"},
            UTF8 {"かいとう"}, UTF8 {"かいふく"}, UTF8 {"がいへき"}, UTF8 {"かいほう"}, UTF8 {"かいよう"}, UTF8 {"がいらい"},
            UTF8 {"かいわ"}, UTF8 {"かえる"}, UTF8 {"かおり"}, UTF8 {"かかえる"}, UTF8 {"かがく"}, UTF8 {"かがし"},
            UTF8 {"かがみ"}, UTF8 {"かくご"}, UTF8 {"かくとく"}, UTF8 {"かざる"}, UTF8 {"がぞう"}, UTF8 {"かたい"},
            UTF8 {"かたち"}, UTF8 {"がちょう"}, UTF8 {"がっきゅう"}, UTF8 {"がっこう"}, UTF8 {"がっさん"},
            UTF8 {"がっしょう"}, UTF8 {"かなざわし"}, UTF8 {"かのう"}, UTF8 {"がはく"}, UTF8 {"かぶか"}, UTF8 {"かほう"},
            UTF8 {"かほご"}, UTF8 {"かまう"}, UTF8 {"かまぼこ"}, UTF8 {"かめれおん"}, UTF8 {"かゆい"}, UTF8 {"かようび"},
            UTF8 {"からい"}, UTF8 {"かるい"}, UTF8 {"かろう"}, UTF8 {"かわく"}, UTF8 {"かわら"}, UTF8 {"がんか"},
            UTF8 {"かんけい"}, UTF8 {"かんこう"}, UTF8 {"かんしゃ"}, UTF8 {"かんそう"}, UTF8 {"かんたん"}, UTF8 {"かんち"},
            UTF8 {"がんばる"}, UTF8 {"きあい"}, UTF8 {"きあつ"}, UTF8 {"きいろ"}, UTF8 {"ぎいん"}, UTF8 {"きうい"},
            UTF8 {"きうん"}, UTF8 {"きえる"}, UTF8 {"きおう"}, UTF8 {"きおく"}, UTF8 {"きおち"}, UTF8 {"きおん"},
            UTF8 {"きかい"}, UTF8 {"きかく"}, UTF8 {"きかんしゃ"}, UTF8 {"ききて"}, UTF8 {"きくばり"}, UTF8 {"きくらげ"},
            UTF8 {"きけんせい"}, UTF8 {"きこう"}, UTF8 {"きこえる"}, UTF8 {"きこく"}, UTF8 {"きさい"}, UTF8 {"きさく"},
            UTF8 {"きさま"}, UTF8 {"きさらぎ"}, UTF8 {"ぎじかがく"}, UTF8 {"ぎしき"}, UTF8 {"ぎじたいけん"},
            UTF8 {"ぎじにってい"}, UTF8 {"ぎじゅつしゃ"}, UTF8 {"きすう"}, UTF8 {"きせい"}, UTF8 {"きせき"},
            UTF8 {"きせつ"}, UTF8 {"きそう"}, UTF8 {"きぞく"}, UTF8 {"きぞん"}, UTF8 {"きたえる"}, UTF8 {"きちょう"},
            UTF8 {"きつえん"}, UTF8 {"ぎっちり"}, UTF8 {"きつつき"}, UTF8 {"きつね"}, UTF8 {"きてい"}, UTF8 {"きどう"},
            UTF8 {"きどく"}, UTF8 {"きない"}, UTF8 {"きなが"}, UTF8 {"きなこ"}, UTF8 {"きぬごし"}, UTF8 {"きねん"},
            UTF8 {"きのう"}, UTF8 {"きのした"}, UTF8 {"きはく"}, UTF8 {"きびしい"}, UTF8 {"きひん"}, UTF8 {"きふく"},
            UTF8 {"きぶん"}, UTF8 {"きぼう"}, UTF8 {"きほん"}, UTF8 {"きまる"}, UTF8 {"きみつ"}, UTF8 {"きむずかしい"},
            UTF8 {"きめる"}, UTF8 {"きもだめし"}, UTF8 {"きもち"}, UTF8 {"きもの"}, UTF8 {"きゃく"}, UTF8 {"きやく"},
            UTF8 {"ぎゅうにく"}, UTF8 {"きよう"}, UTF8 {"きょうりゅう"}, UTF8 {"きらい"}, UTF8 {"きらく"}, UTF8 {"きりん"},
            UTF8 {"きれい"}, UTF8 {"きれつ"}, UTF8 {"きろく"}, UTF8 {"ぎろん"}, UTF8 {"きわめる"}, UTF8 {"ぎんいろ"},
            UTF8 {"きんかくじ"}, UTF8 {"きんじょ"}, UTF8 {"きんようび"}, UTF8 {"ぐあい"}, UTF8 {"くいず"},
            UTF8 {"くうかん"}, UTF8 {"くうき"}, UTF8 {"くうぐん"}, UTF8 {"くうこう"}, UTF8 {"ぐうせい"}, UTF8 {"くうそう"},
            UTF8 {"ぐうたら"}, UTF8 {"くうふく"}, UTF8 {"くうぼ"}, UTF8 {"くかん"}, UTF8 {"くきょう"}, UTF8 {"くげん"},
            UTF8 {"ぐこう"}, UTF8 {"くさい"}, UTF8 {"くさき"}, UTF8 {"くさばな"}, UTF8 {"くさる"}, UTF8 {"くしゃみ"},
            UTF8 {"くしょう"}, UTF8 {"くすのき"}, UTF8 {"くすりゆび"}, UTF8 {"くせげ"}, UTF8 {"くせん"}, UTF8 {"ぐたいてき"},
            UTF8 {"くださる"}, UTF8 {"くたびれる"}, UTF8 {"くちこみ"}, UTF8 {"くちさき"}, UTF8 {"くつした"},
            UTF8 {"ぐっすり"}, UTF8 {"くつろぐ"}, UTF8 {"くとうてん"}, UTF8 {"くどく"}, UTF8 {"くなん"}, UTF8 {"くねくね"},
            UTF8 {"くのう"}, UTF8 {"くふう"}, UTF8 {"くみあわせ"}, UTF8 {"くみたてる"}, UTF8 {"くめる"}, UTF8 {"くやくしょ"},
            UTF8 {"くらす"}, UTF8 {"くらべる"}, UTF8 {"くるま"}, UTF8 {"くれる"}, UTF8 {"くろう"}, UTF8 {"くわしい"},
            UTF8 {"ぐんかん"}, UTF8 {"ぐんしょく"}, UTF8 {"ぐんたい"}, UTF8 {"ぐんて"}, UTF8 {"けあな"}, UTF8 {"けいかく"},
            UTF8 {"けいけん"}, UTF8 {"けいこ"}, UTF8 {"けいさつ"}, UTF8 {"げいじゅつ"}, UTF8 {"けいたい"},
            ...
            UTF8 {"げざん"}, UTF8 {"けしき"}, UTF8 {"けしごむ"}, UTF8 {"けしょう"}, UTF8 {"げすと"}, UTF8 {"けたば"},
            UTF8 {"けちゃっぷ"}, UTF8 {"けちらす"}, UTF8 {"けつあつ"}, UTF8 {"けつい"}, UTF8 {"けつえき"}, UTF8 {"けっこん"},
            UTF8 {"けつじょ"}, UTF8 {"けっせき"}, UTF8 {"けってい"}, UTF8 {"けつまつ"}, UTF8 {"げつようび"},
            ...
            UTF8 {"しらべる"}, UTF8 {"しんか"}, UTF8 {"しんこう"}, UTF8 {"じんじゃ"}, UTF8 {"しんせいじ"},
            UTF8 {"しんちく"}, UTF8 {"しんりん"}, UTF8 {"すあげ"}, UTF8 {"すあし"}, UTF8 {"すあな"}, UTF8 {"ずあん"},
            UTF8 {"すいえい"}, UTF8 {"すいか"}, UTF8 {"すいとう"}, UTF8 {"ずいぶん"}, UTF8 {"すいようび"},
            UTF8 {"すうがく"}, UTF8 {"すうじつ"}, UTF8 {"すうせん"}, UTF8 {"すおどり"}, UTF8 {"すきま"}, UTF8 {"すくう"},
            UTF8 {"すくない"}, UTF8 {"すける"}, UTF8 {"すごい"}, UTF8 {"すこし"}, UTF8 {"ずさん"}, UTF8 {"すずしい"},
            UTF8 {"すすむ"}, UTF8 {"すすめる"}, UTF8 {"すっかり"}, UTF8 {"ずっしり"}, UTF8 {"ずっと"}, UTF8 {"すてき"},
            UTF8 {"すてる"}, UTF8 {"すねる"}, UTF8 {"すのこ"}, UTF8 {"すはだ"}, UTF8 {"すばらしい"}, UTF8 {"ずひょう"},
            UTF8 {"ずぶぬれ"}, UTF8 {"すぶり"}, UTF8 {"すふれ"}, UTF8 {"すべて"}, UTF8 {"すべる"}, UTF8 {"ずほう"},
            UTF8 {"すぼん"}, UTF8 {"すまい"}, UTF8 {"すめし"}, UTF8 {"すもう"}, UTF8 {"すやき"}, UTF8 {"すらすら"},
            UTF8 {"するめ"}, UTF8 {"すれちがう"}, UTF8 {"すろっと"}, UTF8 {"すわる"}, UTF8 {"すんぜん"}, UTF8 {"すんぽう"},
            UTF8 {"せあぶら"}, UTF8 {"せいかつ"}, UTF8 {"せいげん"}, UTF8 {"せいじ"}, UTF8 {"せいよう"}, UTF8 {"せおう"},
            UTF8 {"せかいかん"}, UTF8 {"せきにん"}, UTF8 {"せきむ"}, UTF8 {"せきゆ"}, UTF8 {"せきらんうん"}, UTF8 {"せけん"},
            UTF8 {"せこう"}, UTF8 {"せすじ"}, UTF8 {"せたい"}, UTF8 {"せたけ"}, UTF8 {"せっかく"}, UTF8 {"せっきゃく"},
            UTF8 {"ぜっく"}, UTF8 {"せっけん"}, UTF8 {"せっこつ"}, UTF8 {"せっさたくま"}, UTF8 {"せつぞく"},
            UTF8 {"せつだん"}, UTF8 {"せつでん"},
            ...
            UTF8 {"せんもん"}, UTF8 {"せんやく"}, UTF8 {"せんゆう"},
            UTF8 {"せんよう"}, UTF8 {"ぜんら"}, UTF8 {"ぜんりゃく"},
            UTF8 {"せんれい"}, UTF8 {"せんろ"}, UTF8 {"そあく"},
            UTF8 {"そいとげる"}, UTF8 {"そいね"}, UTF8 {"そうがんきょう"}, UTF8 {"そうき"}, UTF8 {"そうご"},
            UTF8 {"そうしん"},
            ...
            UTF8 {"そんしつ"}, UTF8 {"そんぞく"}, UTF8 {"そんちょう"},
            UTF8 {"ぞんび"}, UTF8 {"ぞんぶん"}, UTF8 {"そんみん"},
            ...
            UTF8 {"だいすき"}, UTF8 {"たいせつ"}, UTF8 {"たいそう"},
            UTF8 {"だいたい"}, UTF8 {"たいちょう"}, UTF8 {"たいてい"},
            ...
            UTF8 {"たすける"}, UTF8 {"たずさわる"}, UTF8 {"たそがれ"},
            UTF8 {"たたかう"}, UTF8 {"たたく"}, UTF8 {"ただしい"},
            ...
            UTF8 {"だんち"}, UTF8 {"たんてい"}, UTF8 {"たんとう"}, UTF8 {"だんな"},
            UTF8 {"たんにん"}, UTF8 {"だんねつ"}, UTF8 {"たんのう"},
            UTF8 {"たんぴん"}, UTF8 {"だんぼう"}, UTF8 {"たんまつ"},
            ...
            UTF8 {"とつぜん"}, UTF8 {"とつにゅう"}, UTF8 {"とどける"},
            UTF8 {"ととのえる"}, UTF8 {"とない"}, UTF8 {"となえる"},
            ...
            UTF8 {"なっとう"}, UTF8 {"なつやすみ"}, UTF8 {"ななおし"},
            UTF8 {"なにごと"}, UTF8 {"なにもの"}, UTF8 {"なにわ"},
            ...
            UTF8 {"にせもの"}, UTF8 {"にちじょう"}, UTF8 {"にちようび"},
            UTF8 {"にっか"}, UTF8 {"にっき"}, UTF8 {"にっけい"},
            ...
            UTF8 {"ねんぶつ"}, UTF8 {"ねんまつ"}, UTF8 {"ねんりょう"},
            UTF8 {"ねんれい"}, UTF8 {"のいず"}, UTF8 {"のおづま"},
            UTF8 {"のがす"}, UTF8 {"のきなみ"}, UTF8 {"のこぎり"}, UTF8 {"のこす"},
            UTF8 {"のこる"}, UTF8 {"のせる"}, UTF8 {"のぞく"}, UTF8 {"のぞむ"}, UTF8 {"のたまう"}, UTF8 {"のちほど"},
            UTF8 {"のっく"}, UTF8 {"のばす"}, UTF8 {"のはら"}, UTF8 {"のべる"}, UTF8 {"のぼる"}, UTF8 {"のみもの"},
            UTF8 {"のやま"},
            ...
            UTF8 {"ばいばい"}, UTF8 {"はいれつ"}, UTF8 {"はえる"}, UTF8 {"はおる"}, UTF8 {"はかい"}, UTF8 {"ばかり"},
            UTF8 {"はかる"},
            ...
            UTF8 {"はっこう"}, UTF8 {"はっさん"}, UTF8 {"はっしん"},
            UTF8 {"はったつ"}, UTF8 {"はっちゅう"}, UTF8 {"はってん"},
            ...
            UTF8 {"はんぶん"}, UTF8 {"はんぺん"}, UTF8 {"はんぼうき"}, UTF8 {"はんめい"}, UTF8 {"はんらん"},
            UTF8 {"はんろん"},
            ...
            UTF8 {"ふいうち"}, UTF8 {"ふうけい"}, UTF8 {"ふうせん"},
            UTF8 {"ぷうたろう"}, UTF8 {"ふうとう"}, UTF8 {"ふうふ"},
            ...
            UTF8 {"ぶんがく"},
            UTF8 {"ぶんぐ"}, UTF8 {"ふんしつ"}, UTF8 {"ぶんせき"}, UTF8 {"ふんそう"}, UTF8 {"ぶんぽう"},
            UTF8 {"へいあん"},
            UTF8 {"へいおん"}, UTF8 {"へいがい"}, UTF8 {"へいき"}, UTF8 {"へいげん"}, UTF8 {"へいこう"}, UTF8 {"へいさ"},
            UTF8 {"へいしゃ"}, UTF8 {"へいせつ"}, UTF8 {"へいそ"},
            UTF8 {"へいたく"}, UTF8 {"へいてん"}, UTF8 {"へいねつ"},
            UTF8 {"へいわ"}, UTF8 {"へきが"}, UTF8 {"へこむ"}, UTF8 {"べにいろ"}, UTF8 {"べにしょうが"}, UTF8 {"へらす"},
            UTF8 {"へんかん"}, UTF8 {"べんきょう"}, UTF8 {"べんごし"}, UTF8 {"へんさい"}, UTF8 {"へんたい"},
            UTF8 {"べんり"},
            UTF8 {"ほあん"}, UTF8 {"ほいく"}, UTF8 {"ぼうぎょ"},
            UTF8 {"ほうこく"}, UTF8 {"ほうそう"}, UTF8 {"ほうほう"},
            UTF8 {"ほうもん"}, UTF8 {"ほうりつ"}, UTF8 {"ほえる"}, UTF8 {"ほおん"}, UTF8 {"ほかん"}, UTF8 {"ほきょう"},
            UTF8 {"ぼきん"}, UTF8 {"ほくろ"}, UTF8 {"ほけつ"}, UTF8 {"ほけん"}, UTF8 {"ほこう"}, UTF8 {"ほこる"},
            UTF8 {"ほしい"},
            UTF8 {"ほしつ"}, UTF8 {"ほしゅ"}, UTF8 {"ほしょう"}, UTF8 {"ほせい"}, UTF8 {"ほそい"}, UTF8 {"ほそく"},
            UTF8 {"ほたて"}, UTF8 {"ほたる"}, UTF8 {"ぽちぶくろ"},
            UTF8 {"ほっきょく"}, UTF8 {"ほっさ"}, UTF8 {"ほったん"},
            UTF8 {"ほとんど"}, UTF8 {"ほめる"}, UTF8 {"ほんい"},
            UTF8 {"ほんき"}, UTF8 {"ほんけ"}, UTF8 {"ほんしつ"},
            UTF8 {"ほんやく"}, UTF8 {"まいにち"}, UTF8 {"まかい"},
            UTF8 {"まかせる"}, UTF8 {"まがる"}, UTF8 {"まける"},
            UTF8 {"まこと"},
            ...
            UTF8 {"まんなか"}, UTF8 {"みいら"}, UTF8 {"みうち"}, UTF8 {"みえる"}, UTF8 {"みがく"}, UTF8 {"みかた"},
            UTF8 {"みかん"},
            UTF8 {"みけん"}, UTF8 {"みこん"}, UTF8 {"みじかい"}, UTF8 {"みすい"}, UTF8 {"みすえる"}, UTF8 {"みせる"},
            UTF8 {"みっか"}, UTF8 {"みつかる"}, UTF8 {"みつける"}, UTF8 {"みてい"}, UTF8 {"みとめる"}, UTF8 {"みなと"},
            UTF8 {"みなみかさい"}, UTF8 {"みねらる"}, UTF8 {"みのう"},
            UTF8 {"みのがす"}, UTF8 {"みほん"}, UTF8 {"みもと"},
            UTF8 {"みやげ"}, UTF8 {"みらい"}, UTF8 {"みりょく"},
            UTF8 {"みわく"}, UTF8 {"みんか"}, UTF8 {"みんぞく"},
            UTF8 {"むいか"}, UTF8 {"むえき"}, UTF8 {"むえん"}, UTF8 {"むかい"}, UTF8 {"むかう"}, UTF8 {"むかえ"},
            UTF8 {"むかし"}, UTF8 {"むぎちゃ"}, UTF8 {"むける"},
            UTF8 {"むげん"}, UTF8 {"むさぼる"}, UTF8 {"むしあつい"},
            UTF8 {"むしば"},
            UTF8 {"むじゅん"}, UTF8 {"むしろ"}, UTF8 {"むすう"}, UTF8 {"むすこ"}, UTF8 {"むすぶ"}, UTF8 {"むすめ"},
            UTF8 {"むせる"}, UTF8 {"むせん"}, UTF8 {"むちゅう"}, UTF8 {"むなしい"}, UTF8 {"むのう"}, UTF8 {"むやみ"},
            UTF8 {"むよう"},
            UTF8 {"むらさき"}, UTF8 {"むりょう"}, UTF8 {"むろん"},
            UTF8 {"めいあん"}, UTF8 {"めいうん"}, UTF8 {"めいえん"},
            UTF8 {"めいかく"}, UTF8 {"めいきょく"}, UTF8 {"めいさい"},
            UTF8 {"めいし"}, UTF8 {"めいそう"}, UTF8 {"めいぶつ"},
            UTF8 {"めいれい"}, UTF8 {"めいわく"}, UTF8 {"めぐまれる"},
            UTF8 {"めざす"}, UTF8 {"めした"}, UTF8 {"めずらしい"},
            UTF8 {"めだつ"}, UTF8 {"めまい"}, UTF8 {"めやす"},
            UTF8 {"めんきょ"}, UTF8 {"めんせき"}, UTF8 {"めんどう"},
            UTF8 {"もうしあげる"}, UTF8 {"もうどうけん"}, UTF8 {"もえる"}, UTF8 {"もくし"}, UTF8 {"もくてき"},
            UTF8 {"もくようび"},
            ...
            UTF8 {"ゆうびんきょく"}, UTF8 {"ゆうべ"}, UTF8 {"ゆうめい"},
            UTF8 {"ゆけつ"}, UTF8 {"ゆしゅつ"}, UTF8 {"ゆせん"},
            UTF8 {"ゆそう"},
            ...
            UTF8 {"よてい"},
            UTF8 {"よどがわく"}, UTF8 {"よねつ"}, UTF8 {"よやく"},
            UTF8 {"よゆう"}, UTF8 {"よろこぶ"}, UTF8 {"よろしい"},
            UTF8 {"らいう"}, UTF8 {"らくがき"}, UTF8 {"らくご"},
            UTF8 {"らくさつ"}, UTF8 {"らくだ"}, UTF8 {"らしんばん"},
            UTF8 {"らせん"}, UTF8 {"らぞく"}, UTF8 {"らたい"}, UTF8 {"らっか"}, UTF8 {"られつ"}, UTF8 {"りえき"},
            UTF8 {"りかい"}, UTF8 {"りきさく"}, UTF8 {"りきせつ"},
            UTF8 {"りくぐん"}, UTF8 {"りくつ"}, UTF8 {"りけん"},
            UTF8 {"りこう"},
            UTF8 {"りせい"}, UTF8 {"りそう"}, UTF8 {"りそく"}, UTF8 {"りてん"}, UTF8 {"りねん"}, UTF8 {"りゆう"},
            UTF8 {"りゅうがく"}, UTF8 {"りよう"}, UTF8 {"りょうり"},
            UTF8 {"りょかん"}, UTF8 {"りょくちゃ"}, UTF8 {"りょこう"},
            UTF8 {"りりく"}, UTF8 {"りれき"}, UTF8 {"りろん"}, UTF8 {"りんご"}, UTF8 {"るいけい"}, UTF8 {"るいさい"},
            UTF8 {"るいじ"}, UTF8 {"るいせき"}, UTF8 {"るすばん"},
            UTF8 {"るりがわら"}, UTF8 {"れいかん"}, UTF8 {"れいぎ"},
            UTF8 {"れいせい"}, UTF8 {"れいぞうこ"}, UTF8 {"れいとう"},
            UTF8 {"れいぼう"}, UTF8 {"れきし"}, UTF8 {"れきだい"},
            UTF8 {"れんあい"}, UTF8 {"れんけい"}, UTF8 {"れんこん"},
            UTF8 {"れんさい"}, UTF8 {"れんしゅう"},
            UTF8 {"れんぞく"}, UTF8 {"れんらく"}, UTF8 {"ろうか"},
            UTF8 {"ろうご"}, UTF8 {"ろうじん"}, UTF8 {"ろうそく"},
            UTF8 {"ろくが"}, UTF8 {"ろこつ"}, UTF8 {"ろじうら"},
            UTF8 {"ろしゅつ"}, UTF8 {"ろせん"}, UTF8 {"ろてん"},
            UTF8 {"ろめん"},
            UTF8 {"ろれつ"}, UTF8 {"ろんぎ"}, UTF8 {"ろんぱ"},
            UTF8 {"ろんぶん"}, UTF8 {"ろんり"}, UTF8 {"わかす"},
            UTF8 {"わかめ"},
            UTF8 {"わかやま"}, UTF8 {"わかれる"}, UTF8 {"わしつ"},
            UTF8 {"わじまし"}, UTF8 {"わすれもの"}, UTF8 {"わらう"},
            UTF8 {"われる"}
        };
