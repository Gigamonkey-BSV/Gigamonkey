...
namespace Gigamonkey::HD {
    ...
    BIP_44::account_secret inline simply_cash_wallet (const string &words, uint32 account = 0, Bitcoin::network net = Bitcoin::network::Main) {
        return BIP_44::master {BIP_32::secret::from_seed (BIP_39::read (words), net)}.account (BIP_44::simply_cash_coin_type, account);
    }

    BIP_44::account_secret inline moneybutton_wallet (const string &words, uint32 account = 0, Bitcoin::network net = Bitcoin::network::Main) {
        return BIP_44::master {BIP_32::secret::from_seed (BIP_39::read (words), net)}.account (BIP_44::moneybutton_coin_type, account);
    }

    BIP_44::account_secret inline relay_x_wallet (const string &words, uint32 account = 0, Bitcoin::network net = Bitcoin::network::Main) {
    ...
    BIP_44::account_secret inline centbee_wallet (const string &words, uint32 pin, Bitcoin::network net = Bitcoin::network::Main) {
