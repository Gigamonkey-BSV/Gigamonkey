...
namespace Gigamonkey {
    ...
    struct proofs_serialization_standard {
        ...
        static proofs_serialization_standard read_binary (byte_slice);
        
        explicit operator JSON () const;
        explicit operator bytes () const;
        
        // whether the full transaction is included or just the txid. 
        static bool transaction_included (byte_slice);
        ...
        static target_type_value target_type (byte_slice);
        ...
        static proof_type_value proof_type (byte_slice);
        ...
        static bool composite_proof (byte_slice);
        ...
        static map<digest256, Merkle::path> paths (byte_slice);
        ...
        static maybe<digest256> block_hash (byte_slice);
        static maybe<digest256> Merkle_root (byte_slice);
        static maybe<Bitcoin::header> block_header (byte_slice);
    ...
    bool inline proofs_serialization_standard::valid (byte_slice b) {
        return read_binary (b).valid ();
    }
    
    byte inline proofs_serialization_standard::flags (byte_slice b) {
    ...
    bool inline proofs_serialization_standard::transaction_included (byte_slice b) {
    ...
    proofs_serialization_standard::target_type_value inline proofs_serialization_standard::target_type (byte_slice b) {
    ...
    proofs_serialization_standard::proof_type_value inline proofs_serialization_standard::proof_type (byte_slice b) {
    ...
    bool inline proofs_serialization_standard::composite_proof (byte_slice b) {
    ...
    maybe<digest256> inline proofs_serialization_standard::block_hash (byte_slice b) {
        auto x = read_binary (b);
        if (x.valid ()) return x.block_hash ();
        return {};
    }
    
    maybe<Bitcoin::header> inline proofs_serialization_standard::block_header (byte_slice b) {
        auto x = read_binary (b);
        if (x.valid ()) return x.block_header ();
        return {};
    }
    
    maybe<digest256> inline proofs_serialization_standard::Merkle_root (byte_slice b) {
        auto x = read_binary (b);
    ...
    digest256 inline proofs_serialization_standard::txid (byte_slice b) {
        auto x = read_binary (b);
    ...
    Merkle::leaf inline proofs_serialization_standard::leaf (byte_slice b) {
        auto x = read_binary (b);
    ...
    Merkle::path inline proofs_serialization_standard::path (byte_slice b) {
        auto x = read_binary (b);
    ...
    Merkle::branch inline proofs_serialization_standard::branch (byte_slice b) {
        auto x = read_binary (b);
    ...
    map<digest256, Merkle::path> inline proofs_serialization_standard::paths (byte_slice b) {
        auto x = read_binary (b);
